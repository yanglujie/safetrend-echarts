...
var worldheatchart = echarts.init(document.getElementById('worldheat'));
...
{'code':'AM' , 'name':'Armenia', 'value':310023600, 'color':'#d8854f'},
...
{'code':'CA' , 'name':'Canada', 'value':343495610, 'color':'#a7a737'},
...
{'code':'CI' , 'name':'Cote d\'Ivoire', 'value':801528940, 'color':'#de4c4f'},
...
optionheat = {
    ...
    tooltip : {
        ...
        formatter : function (params) {
            return  params.name + ' 事件数: ' + params.value[2];//参数和下面的series.data里的格式一致
...
worldheatchart.setOption(optionheat);
